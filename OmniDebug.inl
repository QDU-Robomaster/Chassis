...
inline int Omni::DebugCommand(int argc, char** argv) {
  ...
  static const debug_core::LiveFieldDesc<Omni> fields[] = {
      ...
      DEBUG_CORE_LIVE_F32(Omni, "imu_yaw", mask_state, self->imu_yaw_),
      DEBUG_CORE_LIVE_F32(Omni, "imu_pitch", mask_state, self->imu_pitch_),
      DEBUG_CORE_LIVE_F32(Omni, "imu_roll", mask_state, self->imu_roll_),
